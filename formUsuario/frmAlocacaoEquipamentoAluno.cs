...
namespace formUsuario
{
    public partial class frmAlocacaoEquipamentoAluno : Form
    {
        ...
        public void mudarStatusAlocacaoAlunoDeslocado()
        {
            Conexao conexao = new Conexao();
            conexao.conectar();
            SqlCommand cmd = new SqlCommand("STATUSALOCACAOALUNODESALOCADO", conexao.conexao);
            cmd.CommandType = CommandType.StoredProcedure;
            cmd.Parameters.AddWithValue("@ID_ALOCACAO_ALUNO", idAloc);
            cmd.ExecuteReader(CommandBehavior.SingleRow);
            conexao.desconectar();
            carregarEquipamentos();
        }
        ...
        private void btnDevolver_Click(object sender, EventArgs e)
        {
            ...
            if (operacao == 1)
            {
                ...
                mudarStatusAlocacaoAlunoDeslocado();
                carregarEquipamentos();
                telaInicial();
                limpar();
            }
        ...
        public void exibirDados(string nome)
        {
            ...
            if (dr.Read())
            {
                ...
                idAloc = Convert.ToInt32(dr[("ID_ALOCACAO_ALUNO")]);
        ...
        private void txtIdAlocacao_TextChanged(object sender, EventArgs e)
        {
